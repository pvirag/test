...
"use strict";function handleDisplay(a){var e=$("#"+a);e.siblings("article").hide(),e.fadeIn("slow")}function handleSelect(){var a=$("select.room-list");a.on("change",function(a){handleDisplay(a.target.value),$("ul.room-list li").removeClass("active"),$('[data-id="'+a.target.value+'"]').addClass("active")})}function handleList(){var a=$("ul.room-list");a.children("li").on("click",function(a){handleDisplay($(a.target).attr("data-id")),$(this).siblings("li").removeClass("active"),$(this).addClass("active")})}module.exports=function(){handleList(),handleSelect()};
